  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <nav className="border-b border-white/8 px-4 h-16 flex items-center max-w-7xl mx-auto justify-between">
        ...
        <Link to="/signup" className="bg-blue-500 hover:bg-blue-400 text-white text-sm font-semibold px-4 py-2 rounded-lg transition-colors">Get started free</Link>
      </nav>
      <div className="max-w-5xl mx-auto px-4 py-16 sm:py-24">
        <div className="text-center mb-16">
          <p className="text-5xl mb-4">🔧</p>
          <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">For Plumbers</p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-16">
          <div>
            ...
            <div className="mt-8 glass rounded-xl p-5 border border-blue-500/20">
              <p className="text-xs text-gray-500 mb-1">Average job value</p>
              <p className="text-3xl font-extrabold text-blue-400">$280</p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="glass rounded-xl p-4 border border-white/8">
                <p className="text-xs text-blue-400 font-semibold mb-2 flex items-center gap-1.5"><Phone size={11} /> Burst pipe at 2am</p>
              ...
              <div className="glass rounded-xl p-4 border border-white/8">
                <p className="text-xs text-blue-400 font-semibold mb-2 flex items-center gap-1.5"><Phone size={11} /> Hot water system gone</p>
              ...
              <div className="glass rounded-xl p-4 border border-white/8">
                <p className="text-xs text-blue-400 font-semibold mb-2 flex items-center gap-1.5"><Phone size={11} /> Blocked drain enquiry</p>
        ...
        <div className="glass rounded-2xl p-8 sm:p-12 border border-blue-500/20 text-center">
          ...
          <Link to="/signup" className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-400 text-white font-semibold px-8 py-4 rounded-xl transition-all text-lg">
