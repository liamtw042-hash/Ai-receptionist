    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-16 sm:py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">For Electricians</p>
        ...
        <div className="grid lg:grid-cols-2 gap-10 mb-16">
          <div>
            ...
            <div className="mt-8 glass rounded-xl p-5 border border-blue-500/20">
              ...
              <p className="text-3xl font-extrabold text-blue-400">$240</p>
          ...
          <div>
            ...
            <div className="space-y-4">
              <div className="glass rounded-xl p-4 border border-white/8">
                <p className="text-xs text-blue-400 font-semibold mb-2 flex items-center gap-1.5"><Phone size={11} /> Safety switch tripped</p>
              ...
              <div className="glass rounded-xl p-4 border border-white/8">
                <p className="text-xs text-blue-400 font-semibold mb-2 flex items-center gap-1.5"><Phone size={11} /> EV charger quote</p>
              ...
              <div className="glass rounded-xl p-4 border border-white/8">
                <p className="text-xs text-blue-400 font-semibold mb-2 flex items-center gap-1.5"><Phone size={11} /> Power outage</p>
