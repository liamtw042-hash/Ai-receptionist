    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <nav className={`fixed top-0 inset-x-0 z-50 transition-all duration-300 ${
        ...
        <div className="max-w-6xl mx-auto px-5 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <Link to="/signup" className="text-sm font-medium bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-all blue-glow">
              Get Started
            </Link>
          </div>
        ...
        {menuOpen && (
          <div className="md:hidden bg-black/95 backdrop-blur-md border-b border-white/8 px-5 py-4 space-y-4 animate-fade-in">
            <a href="#how-it-works" className="block text-sm text-gray-300 hover:text-white" onClick={() => setMenuOpen(false)}>How it works</a>
            <a href="#features" className="block text-sm text-gray-300 hover:text-white" onClick={() => setMenuOpen(false)}>Features</a>
            <a href="#pricing" className="block text-sm text-gray-300 hover:text-white" onClick={() => setMenuOpen(false)}>Pricing</a>
            <div className="flex gap-3 pt-2">
              <Link to="/login" className="flex-1 text-center text-sm glass rounded-lg py-2.5 text-gray-300">Log in</Link>
              <Link to="/signup" className="flex-1 text-center text-sm bg-blue-500 rounded-lg py-2.5 font-medium">Get Started</Link>
            </div>
          </div>
        )}
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-5 text-center py-20">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/signup"
              className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold px-7 py-3.5 rounded-xl text-base transition-all blue-glow active:scale-[0.98]">
              Get Started Free <ArrowRight size={18} />
            </Link>
            <a href="#how-it-works"
              className="inline-flex items-center gap-2 glass glass-hover text-white font-medium px-7 py-3.5 rounded-xl text-base transition-all">
              See how it works
            </a>
          </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 relative">
            ...
            {[
              ...
              <div key={step} className="relative glass rounded-2xl p-7 flex flex-col items-start">
            ...
            {[
              {
                ...
                desc: 'Never miss a lead. Your AI picks up in under 2 seconds, any time of day or night, weekends included.',
                color: 'text-blue-400', bg: 'bg-blue-500/15',
              },
              {
                icon: MessageSquare,
                title: 'Instant SMS summaries',
                desc: 'After every call you get a text: caller number, what they needed, quotes given, and what was agreed.',
                color: 'text-green-400', bg: 'bg-green-500/15',
              },
              {
                icon: Mail,
                title: 'Email auto-reply',
                desc: 'Connect your Gmail and the AI replies to enquiry emails automatically with accurate pricing and availability.',
                color: 'text-purple-400', bg: 'bg-purple-500/15',
              },
              {
                icon: Clock,
                title: 'Missed call text-back',
                desc: 'If a call goes unanswered for any reason, the caller automatically gets a text within 60 seconds to re-engage them.',
                color: 'text-yellow-400', bg: 'bg-yellow-500/15',
              },
              {
                icon: FileText,
                title: 'Full call transcripts',
                desc: 'Every conversation is recorded and searchable in your dashboard. Know exactly what was said on every call.',
                color: 'text-pink-400', bg: 'bg-pink-500/15',
              },
              {
                icon: Zap,
                title: 'Live in 10 minutes',
                desc: 'Sign up, enter your business details, forward your calls. No hardware, no technical setup. Done.',
                color: 'text-orange-400', bg: 'bg-orange-500/15',
              },
            ].map(({ icon: Icon, title, desc, color, bg }) => (
              <div key={title} className="glass glass-hover rounded-2xl p-6 transition-all duration-300 group">
        ...
        <div className="flex animate-[marquee_25s_linear_infinite] whitespace-nowrap gap-12">
          {[...Array(3)].map((_, i) =>
            ['Plumber', 'Electrician', 'Builder', 'Carpenter', 'Painter', 'Roofer', 'Landscaper', 'Tiler', 'Locksmith', 'HVAC tech'].map(trade => (
              <span key={`${trade}-${i}`} className="text-sm text-gray-600 flex items-center gap-2">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="max-w-md mx-auto">
            <div className="relative">
              ...
              <div className="relative glass rounded-2xl p-8">
                ...
                <Link to="/signup"
                  className="flex items-center justify-center gap-2 w-full bg-blue-500 hover:bg-blue-600 text-white font-semibold py-3.5 rounded-xl transition-all blue-glow">
          ...
          <div className="text-center mt-10">
            <p className="text-sm text-gray-500">
              <span className="text-white font-medium">30-day money-back guarantee.</span> If TradeDesk doesn't pay for itself in the first month, we'll refund you in full — no questions asked.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-5 relative overflow-hidden">
        ...
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/signup"
              className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-600 text-white font-semibold px-8 py-4 rounded-xl text-base transition-all blue-glow">
              Get Started Free <ArrowRight size={18} />
            </Link>
      ...
      <footer className="border-t border-white/8 py-10 px-5">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-gray-600">Made in Newcastle, NSW 🇦🇺</p>
          <div className="flex items-center gap-6">
            <Link to="/login" className="text-sm text-gray-600 hover:text-gray-400 transition-colors">Log in</Link>
            <Link to="/signup" className="text-sm text-gray-600 hover:text-gray-400 transition-colors">Sign up</Link>
          </div>
        </div>
      </footer>
