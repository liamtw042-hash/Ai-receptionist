    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-16 sm:py-24">
        <div className="text-center mb-12">
          <p className="text-blue-400 text-xs font-semibold uppercase tracking-widest mb-3">Comparison</p>
        ...
        <div className="glass rounded-2xl overflow-hidden border border-white/10 mb-12">
          <div className="grid grid-cols-3 text-xs font-semibold border-b border-white/10 bg-white/[0.015]">
            ...
            <div className="py-4 px-4 bg-blue-500/10 border-x border-blue-500/20 text-blue-400 flex items-center justify-center gap-1"><Zap size={12} /> TradeDesk</div>
          ...
          {ROWS.map(({ feature, td, tm, winner }, i) => (
            <div key={feature} className={`grid grid-cols-3 border-b border-white/5 last:border-0 text-xs ${i % 2 !== 0 ? 'bg-white/[0.012]' : ''}`}>
              ...
              <div className={`py-3.5 px-4 self-center bg-blue-500/5 border-x border-blue-500/10 flex items-center gap-1.5 ${winner === 'td' ? 'text-white font-medium' : 'text-gray-400'}`}>
        ...
        <div className="glass rounded-2xl p-8 border border-blue-500/20 text-center">
          ...
          <Link to="/signup" className="inline-flex items-center gap-2 bg-blue-500 hover:bg-blue-400 text-white font-semibold px-8 py-4 rounded-xl transition-all">
            Switch to TradeDesk free <ArrowRight size={16} />
          </Link>
