...
You are responsible for ensuring your use of the Service complies with applicable Australian laws, including those relating to call recording and AI disclosure.` },
            ...
            { heading: '7. 30-Day Money-Back Guarantee', body: 'New subscribers may request a full refund within 30 days of their first payment if not satisfied. To request a refund, email hello@tradedesk.com.au.' },
            ...
            { heading: '14. Contact', body: 'For questions about these Terms: hello@tradedesk.com.au · TradeDesk · Newcastle NSW 2300 · Australia' },
          ].map(({ heading, body }) => (
            <div key={heading}>
